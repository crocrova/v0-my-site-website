  ...
  useEffect(() => {
    ...
    for (let ix = 0; ix < AMOUNTX; ix++) {
      for (let iy = 0; iy < AMOUNTY; iy++) {
        ...
        colors.push(0.78, 0.94, 0); // #C8F000 in normalized RGB
      }
    }
    ...
    const material = new THREE.PointsMaterial({ size: 6, vertexColors: true, transparent: true, opacity: 0.15, sizeAttenuation: true });
